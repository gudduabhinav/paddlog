        ...
        <div className="container mx-auto px-6 max-w-[1280px] grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-slate-900 rounded-[2.5rem] p-10 text-white relative overflow-hidden group">
              ...
              <a href="tel:+917386107071" className="flex items-center gap-4 bg-white/10 hover:bg-white/20 p-4 rounded-2xl transition-all group relative z-10">
                <div className="w-12 h-12 bg-primary rounded-xl flex items-center justify-center text-white">
                  <PhoneCall size={20} />
                </div>
                <div>
                  <div className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Speak to Experts</div>
                  <div className="text-sm font-black">+91 7386107071</div>
                </div>
              </a>
            </div>
