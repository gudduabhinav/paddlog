      ...
      <div className="container mx-auto px-6">
        ...
        <div className="pt-4 border-t border-slate-100 pb-4">
          <div className="flex flex-col items-center justify-center text-center space-y-3">
            ...
            {/* Bllinto Branding - Simplified & Tightened */}
            <div className="flex items-center gap-1 pt-1 opacity-80 hover:opacity-100 transition-opacity">
              <p className="text-slate-400 text-[10px] font-medium tracking-wide">
                ...
                <a
                  href="https://bllinto.in"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-slate-600 hover:text-primary transition-colors font-bold"
                >
                  Bllinto
                </a>
              </p>
